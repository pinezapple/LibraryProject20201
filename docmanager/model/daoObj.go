...
type PaymentDAOobj struct {
	...
	Fine          uint64      `protobuf:"varint,3,opt,name=Fine,proto3" json:"fine" db:"fine"`
	BarcodeID     []byte      `protobuf:"varint,4,rep,packed,name=BarcodeID,proto3" json:"barcode_id" db:"barcode_id"`
	BarcodeStatus []byte      `protobuf:"varint,5,rep,packed,name=BarcodeStatus,proto3" json:"barcode_status" db:"barcode_status"`
	Money         []byte      `protobuf:"varint,6,rep,packed,name=Money,proto3" json:"money" db:"money"`
